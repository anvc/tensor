...
$config['archives'][] = array(
	...
	'categories' 	=> array('audio', 'video', 'image','contentdm','other'),
	'logo'			=> '',
	'thumbnail'		=> 'views/ui/images/washingtondigitalcollections.thumb.png',
	'teaser'		=> '',
	'request'		=> array(
		'handler'		=> 'http',
		'parser'  		=> "contentdm-icons",
...
$config['archives'][] = array(
	...
	'categories' 	=> array('audio', 'video', 'image','contentdm','other'),
	'logo'			=> '',
	'thumbnail'		=> 'views/ui/images/ccdl.thumb.png',
	'teaser'		=> '',
	'request'		=> array(
		'handler'		=> 'http',
		'parser'  		=> "contentdm-table",
...
$config['archives'][] = array(
	...
	'categories' 	=> array('audio', 'video', 'image','contentdm','other'),
	'logo'			=> '',
	'thumbnail'		=> 'views/ui/images/huntington.thumb.png',
	'teaser'		=> '',
	'request'		=> array(
		'handler'		=> 'http',
		'parser'  		=> "contentdm-table",
...
$config['archives'][] = array(
	...
	'categories' 	=> array('audio', 'video', 'image','contentdm','other'),
	'logo'			=> '',
	'thumbnail'		=> 'views/ui/images/ubc.thumb.png',
	'teaser'		=> '',
	'request'		=> array(
		'handler'		=> 'http',
		'parser'  		=> "contentdm-table",
...
$config['archives'][] = array(
	...
	'logo'			=> '',
	'thumbnail'		=> 'views/ui/images/internetarchive.thumb.png',
	'teaser'		=> '',
	'request'		=> array(
		'handler'		=> 'http',
